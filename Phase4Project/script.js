...
let finalpagemodal = new bootstrap.Modal(
  document.getElementById("pageno3modal")
);
let reviewanswerpagemodal = new bootstrap.Modal(
  document.getElementById("pageno3reviewmodal")
);
let myinterval;
...
function reviewtheanswers() {
  ...
  for (x = 0; x < questions.length; x++) {
    ...
    if (
      ...
      temp =
        "<ul id='reviewspace' style='border: 2px solid royalblue;box-shadow:0px 0px 10px 5px grey;'><li class='text-dark' style='font-weight: bold;'>Question " +
        (x + 1) +
        " : <b>" +
        questions[x].q +
        "</b></li><li class='text-primary'>Your Answer : <b>" +
        questions[x][selectedanswers[x]] +
        "</b></li><li class='text-success'>Correct Answer : <b>" +
...
function timerstart() {
  ...
  myinterval = window.setInterval(() => {
    ...
    if (
      ...
      if (ctrl == 2) {
        document.getElementById("inputtime").style.fontSize = "32px";
        ctrl++;
      } else if (ctrl == 3) {
        document.getElementById("inputtime").style.fontSize = "34px";
        ctrl++;
      } else if (ctrl == 4) {
        document.getElementById("inputtime").style.fontSize = "36px";
        ctrl++;
      } else if (ctrl == 5) {
        document.getElementById("inputtime").style.fontSize = "34px";
        ctrl++;
        ...
        document.getElementById("inputtime").style.fontSize = "30px";
        ctrl = 1;
      } else {
        ctrl++;
      }
      ...
      document
        ...
        .setAttribute("class", "text-secondary");
    } else {
      document
        .getElementById("inputtime")
...
function jumptoquestion(x) {
  ...
  if (selectedanswers[count] != null) {
    console.log(
      ...
      " visible as the selectedanswers exist"
    );
...
function setpanelforquestions() {
  ...
  for (let x = 0; x < questions.length; x++) {
    questionpaneltext = questionpaneltext.concat(
      "<a onclick='jumptoquestion(" +
        x +
        ")' id='qref" +
        x +
        "' class='btn btn-outline-primary'>Question " +
        (x + 1) +
        " (<span style='color:yellow;'>Answered</span>)</a><hr style='color: seashell;'>"
    );
  }
...
function setquestionbuttonsproper() {
  document
    .getElementById("qref" + count)
    .setAttribute("class", "btn btn-primary disabled");
  for (let x = 0; x < questions.length; x++) {
    if (selectedanswers[x] == null) {
      document.getElementById("qref" + x).childNodes[1].innerHTML =
        "Not Answered";
